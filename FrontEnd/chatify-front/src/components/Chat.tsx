...
const Chat: React.FC = () => {
  ...
  const handleSend = () => {
    ...
    fetch(
      `${
        config.apiBaseUrl
      }/chat/ask-music-question/?question=${encodeURIComponent(input)}`,
      {
        method: "POST",
      }
    )
            ...
            >
              <Box
                sx={{
                  ...
                  backgroundColor:
                    msg.sender === "user" ? "#414141" : "#303030", //color user : bot
                  color: "#fff",
                  borderRadius:
                    msg.sender === "user"
                      ? "15px 15px 0px 15px"
                      : "15px 15px 15px 0px", //redondeo esquinas user : bot
                  padding: "8px 12px",
              ...
              >
                <ListItemText
                  primary={
                    <span
                      dangerouslySetInnerHTML={renderTextToHtml(msg.text)}
                    />
        ...
        <TextField
          ...
          sx={{
            ...
            "& .MuiOutlinedInput-root": {
              //Eliminamos el borde y sus variaciones cuando se toca el componente
              "& fieldset": {
                border: "none",
              },
              "&:hover fieldset": {
